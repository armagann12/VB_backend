...
namespace JWTAuth.WebApi.Controllers
{
    ...
    public class TokenController : ControllerBase
    {
        ...
        private async Task<UserModel> GetUser(string mail, string password)
        {
            return await _context.UserModels.FirstOrDefaultAsync(u => u.mail == mail && u.password == password);
        }
    }
}